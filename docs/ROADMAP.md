...
| ------- | --------------------------------------------- | ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| v0.61   | Adaptive week autopilot (MVP)                 | Weekly plan adjusts to what actually happened, not just what was planned.             | 1) Compute weekly adherence signal from planned vs actual load and completion. 2) Apply bounded next-week adjustment (`-15%` to `+10%`) with explicit reason codes. 3) Emit deterministic rationale text for every auto-adjust decision. 4) Keep existing safety rails (missed-week restart and readiness suppression) intact. 5) Add deterministic tests for high/low/neutral adherence paths. |
