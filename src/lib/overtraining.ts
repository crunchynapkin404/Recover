 ...
 * detection runs. Source: `docs/specs/2026-07-15-v0.4b-proactive-engine-design.md`
 * — the umbrella minimum covering both internal windows (≥7-day HRV
 * suppression run, 3-day RHR-spike mean) plus a stable baseline; not an
 * external citation. Confidence: Low.
 */
