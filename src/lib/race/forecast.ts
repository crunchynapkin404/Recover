 ...
 * scales planned loads by. Source: `docs/specs/2026-07-19-v0.14-race-ready-design.md`
 * states the floor explicitly ("recent adherence... floored at 0.5") to stop
 * a near-zero-adherence week collapsing the forecast; the same doc never
