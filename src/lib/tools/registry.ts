...
/** All registered tools (59 — docs/PLAN.md MCP design + v0.4a memory + v0.4c depth + v0.5a artifacts + v0.5c calendar + v0.5d training plans + v0.6 strava describe + v0.9.2 living week + v0.9.6 absorbed icu_* tools + v0.9.6 workout-syntax reference tool + v0.13 get_biomarkers + v0.14 races/what-if + v0.15 recall + v0.20 standard week / clear override + v0.43 confirm_training_plan + v0.116 get_race_pacing + strength-training get_strength_prescription). */
